            ...
            {notifications.length === 0 ? (
              ...
              notifications.map((n) => (
                <button
                  ...
                  className={clsx(
                    'w-full text-left p-3 border-b border-gray-50 hover:bg-gray-50 transition-colors flex gap-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500',
