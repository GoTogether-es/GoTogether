...
import { Button, Container, Section } from '@gotogether/ui';
      ...
      <Container>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/">
              <Button variant="primary" className="h-12 px-8 flex items-center gap-2 shadow-lg shadow-blue-600/20 w-full sm:w-auto">
                <ArrowLeft className="w-4 h-4" />
                Volver al inicio
              </Button>
            </Link>
            <Link href={routes.explorar}>
              <Button variant="ghost" className="h-12 px-8 flex items-center gap-2 w-full sm:w-auto text-blue-600">
